...
import { C as Leaf, F as DollarSign, f as ShieldAlert, m as Send, z as CircleCheck } from "../_libs/lucide-react.mjs";
import { a as CardTitle, i as CardHeader, n as CardContent, r as CardDescription, t as Card } from "./card-CtX3ithx.mjs";
import { n as PageHeader, t as Badge } from "./page-header-Dam7wNGy.mjs";
import { i as loadPlan, n as loadAnalysis, o as saveApprovalRequest } from "./workflow-store-Hbw_5P2e.mjs";
import { n as toast } from "../_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/app.submit-approval-AvNhv0FB.js
...
function SubmitApprovalPage() {
	...
	const handleSubmit = () => {
		...
		saveApprovalRequest({
			...
			date: (/* @__PURE__ */ new Date()).toLocaleDateString() + ", " + (/* @__PURE__ */ new Date()).toLocaleTimeString([], {
				hour: "2-digit",
				minute: "2-digit"
			}),
